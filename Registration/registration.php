    ...
    <div class="container">
      ...
      <form name="Form" action="validation.php" onsubmit="return validateForm()" method="post">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="auth" id="inlineRadio1" value="Admin" required>
              <label class="form-check-label" for="inlineRadio1">Admin</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="auth" id="inlineRadio2" value="Operator" required>
              <label class="form-check-label" for="inlineRadio2">Operator</label>
            </div>
          </div>
        </div>
